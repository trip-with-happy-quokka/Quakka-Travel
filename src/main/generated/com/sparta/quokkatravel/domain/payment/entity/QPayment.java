...
public class QPayment extends EntityPathBase<Payment> {
    ...
    public final EnumPath<PayMethod> paymentMethod = createEnum("paymentMethod", PayMethod.class);

    public final EnumPath<PayStatus> paymentStatus = createEnum("paymentStatus", PayStatus.class);
