...
public class QReservation extends EntityPathBase<Reservation> {
    ...
    public final com.sparta.quokkatravel.domain.accommodation.entity.QRoom room;
    ...
    public QReservation(Class<? extends Reservation> type, PathMetadata metadata, PathInits inits) {
        ...
        this.room = inits.isInitialized("room") ? new com.sparta.quokkatravel.domain.accommodation.entity.QRoom(forProperty("room"), inits.get("room")) : null;
